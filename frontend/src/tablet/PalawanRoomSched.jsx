      ...
      try {
        ...
        if (bookResponse.status === 200) {
          const filteredData = bookResponse.data.filter(
            (event) => event.roomName === "Palawan" && event.confirmation === true && event.title || event.roomName === "Palawan and Boracay"
          );
...
export default PalawanRoomSched;
