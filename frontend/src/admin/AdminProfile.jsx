    ...
    return(
        <div style={{margin:'50px 500px'}}>
            <div className="listCont5" >
                ...
                <div className='changeFields_admin'>
                    <form onSubmit={handleSubmit}>
                        <div className='formGroup_admin'>
                        ...
                        <div className='formGroup_admin' style={{position:'relative'}}>
                            ...
                            <div className='passwordInputContainer'>
                                ...
                                <button
                                    ...
                                    className='togglePasswordBtn_admin' // Apply a custom class for styling
                                >
