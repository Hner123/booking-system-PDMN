...
const SidebarComponent = () => {
    ...
    return (
        <>
            {/* state icons */}
            <div className='sidebar-collapsed'  onClick={showSidebar}>
                <div className="logodb" style={{ padding: '0' }}>
            ...
            <nav className={sidebar ? 'menu active' : 'menu'}>
                ...
                {/* Move LOG OUT here */}
                {/* <div style={{ textAlign: 'center', bottom:'20px'}}>LOG OUT</div> */}
            </nav>
